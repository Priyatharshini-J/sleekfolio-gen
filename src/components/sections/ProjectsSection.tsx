...
const ProjectsSection = () => {
  ...
  const projects: Project[] = [
    ...
    },
    {
      ...
      description:
        "A customizable portfolio website template for creatives and developers.",
    ...
    },
    {
      ...
      description:
        "A beautiful weather dashboard with forecasts, maps, and location search.",
    ...
    },
    {
      ...
      description:
        "A comprehensive UI kit for mobile app designers with 100+ components.",
    ...
    },
    {
      ...
      description:
        "A technical blog with articles on web development and programming.",
  ...
  const visitProject = (url: string, title: string) => {
    if (url === "https://github.com") {
      ...
      toast({
        title: `${title}`,
        description: `Demo is not available for this project.`,
      });
    }
  };
      ...
      <div className="container max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {filteredProjects.map((project) => (
            <Card
              key={project.id}
              className={`glass-card overflow-hidden hover-card transition-opacity duration-300 ${
            ...
            >
              ...
              <CardFooter className="flex justify-between">
                <Button
                  ...
                  onClick={() =>
                    visitProject(project.repoUrl, `${project.title} repository`)
                  }
                >
