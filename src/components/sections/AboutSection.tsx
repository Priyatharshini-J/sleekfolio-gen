        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-6">
            <h3 className="text-2xl font-bold">
              Hi, I'm <span className="text-gradient">Zylker Dev</span>
            </h3>
            <p className="text-muted-foreground">
              I'm a passionate developer and designer with over 5 years of
              experience creating beautiful, functional digital experiences. My
              expertise spans across frontend development, UI/UX design, and
              building scalable web applications.
            </p>
            <p className="text-muted-foreground">
              I believe in clean code, thoughtful design, and delivering
              projects that exceed expectations. When I'm not coding, you can
              find me hiking, reading, or exploring new coffee shops.
            </p>
